...
A Flask-based web app to shorten URLs and redirect to original links, with SQLite storage. Tracks clicks, creation timestamps, and expires URLs after 30 days.  
